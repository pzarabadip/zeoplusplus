...
proc sample_acc_nodes {probeRad} {
    ...
    if {[string equal $accuflag "None"]} {
      ...
      run_network_program [list "-ha" $accuflag "-r" "-axs" $probeRad "ZeoVisInput.axs" $inputFile]
    }
  }
...
proc sample_ray_atom {chanRad probeRad  numSamples} {
    ...
    run_network_program [list "-ha" $accuflag "-r" "-zray_atom" $chanRad $probeRad $numSamples "ZeoVisInput.zray_atom" $inputFile]
...
proc sample_ray_sphere {chanRad probeRad numSamples} {
    global inputFile num_atoms list_of_actions draw_count
    run_network_program [list "-ha" $accuflag "-r" "-zray_sphere" $chanRad $probeRad $numSamples "ZeoVisInput.zray_sphere" $inputFile]
...
proc sample_ray_node {chanRad probeRad numSamples} {
    global inputFile num_atoms list_of_actions draw_count
    run_network_program [list "-ha" $accuflag "-r" "-zray_node" $chanRad $probeRad $numSamples "ZeoVisInput.zray_node" $inputFile]
...
proc sample_ray_andrew_sphere {chanRad probeRad  numSamples} {
    global inputFile num_atoms list_of_actions draw_count
    run_network_program [list "-ha" $accuflag "-r" "-zray_andrew_sphere" $chanRad $probeRad $numSamples "ZeoVisInput.zray_andrew_sphere" $inputFile]
...
proc sample_ray_andrew_atom {chanRad probeRad  numSamples} {
    global inputFile num_atoms list_of_actions draw_count
    run_network_program [list "-ha" $accuflag "-r" "-zray_andrew_atom" $chanRad $probeRad $numSamples "ZeoVisInput.zray_andrew_atom" $inputFile]
...
proc sample_surface_area {probeRad numSamples} {
    global inputFile num_atoms list_of_actions draw_count
    run_network_program [list "-ha" $accuflag "-r" "-zsa" $probeRad $probeRad $numSamples "ZeoVisInput.zsa" $inputFile]
...
proc id_channels {probeRad} {
    ...
    run_network_program [list "-ha" $accuflag "-r" "-zchan" $probeRad "ZeoVisInput.zchan" $inputFile]
...
proc id_segments {} {
    ...
    run_network_program [list "-ha" $accuflag "-r" "-zseg" $probe_radius "ZeoVisInput.zseg" $inputFile]
...
proc id_features {} {
    ...
    run_network_program [list "-ha" $accuflag "-r" "-zfeat" $probe_radius "ZeoVisInput.zfeat" $inputFile]
...
proc id_cages {probeRad} {
    ...
    set num_cages 0
    run_network_program [list "-ha" $accuflag "-r" "-zcage" $probeRad "ZeoVisInput.zcage" $inputFile]
...
proc load_new_file {fileName incRadius} {
    ...
    clear_env
    run_network_program [list "-ha" $accuflag "-r" "-zvor" $incRadius "ZeoVisInput.zor" $fileName]
